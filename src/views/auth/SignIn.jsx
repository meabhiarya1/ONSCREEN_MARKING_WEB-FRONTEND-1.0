...
export function SignIn() {
  ...
  // return (
  //   <>
      // <div className="flex  min-h-screen items-center justify-center px-4 py-6 font-[sans-serif] text-gray-800">
      //   <div className="max-w-8xl flex w-full items-center justify-center gap-6">
      //     <div className="max-md:mx-auto w-full max-w-md rounded-lg border border-gray-400 bg-white px-8 pb-8 shadow-lg shadow-indigo-100 drop-shadow-2xl animate-fadeIn">
      //       <div className="logo flex justify-center"><img src={logo} alt="" width={120}/></div>
      //       <form className="space-y-6" onSubmit={handleSubmitEmailPassword}>
      //         <div className="mb-8">
      //           <h3 className="font-poppins text-4xl font-semibold drop-shadow-2xl text-indigo-600 animate-bounceCustom">
      //             Hello, <br /> Welcome Back
      //           </h3>
      //           <p className="mt-4 text-sm text-gray-900 font-poppins">
      ...
      //               }
      //             />
      //             <span className="absolute right-3 top-3 h-5 w-5 cursor-pointer">
      //             <FaUser />
      //             </span>
      //           </div>
      //         </div>
      ...
      //                 setUser({ ...user, password: e.target.value })
      //               }
      //               className="bg-transparent focus:ring-sky-500 focus:border-sky-500 w-full rounded-md border border-gray-500 px-4 py-2 text-sm transition duration-300 placeholder:text-gray-700 focus:outline-none focus:ring-2"
      //               placeholder="Enter password"
      //             />
      //             <span
      ...
      //           </label>
      //           <span className="cursor-pointer text-sm text-indigo-600 hover:underline">
      //             login with OTP
      //           </span>
      //         </div>
      //         <div>
      //           <button
      //             type="submit"
      //             className="w-full rounded-lg bg-indigo-600 px-4 py-3 font-semibold text-white shadow-lg hover:bg-indigo-700 focus:ring focus:ring-indigo-600 focus:ring-opacity-50"
      //           >
      //             Log in
      //           </button>
      //         </div>
